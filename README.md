# MESA-Brown-Dwarf-Stars-Cooling-Curve-Surrogate-Supplementary-Codes-and-Files
Listed below are the editable files and codes that are used for the brown dwarf stars surrogate simulation for MESA cooling curves. 
The entire simulation is done via Primary Code.ipynb (Jupyter notebook). This repository consists of the following:
